...
const className = {
    yellow: "cursor-pointer rounded-md flex gap-2 text-sm px-2 py-1 hover:scale-105 transition-all items-center font-bold bg-[var(--button-primary)] disabled:bg-[var(--button-primary)]/90 text-primary-foreground hover:brightness-110",
