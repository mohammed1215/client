            ...
            <main className="flex-1 p-6 overflow-auto bg-primary">
                <div className="bg-background rounded-lg shadow p-6 h-full border border-border">
                    ...
                    <div className="grid grid-cols-3 gap-6 mt-8">
                        <CardDashboard
                            Icon={List}
                            iconStyles=" bg-[#1a2a44] w-14 h-16 text-[#137eeb] px-1 pt-2 pb-6"
                            className=""
                            label="Task Numbers"
                            numbers={"155"}
                        />
                        <CardDashboard
                            Icon={Timer}
                            iconStyles=" bg-[#2d272c] w-14 h-16 text-[#f97316] px-1 pt-2 pb-6"
                            className=""
                            label="Task Numbers"
                            numbers={"235"}
                        />
                        <CardDashboard
                            ...
                            iconStyles=" bg-[#262443] w-14 h-16 text-[#a855f7] px-1 pt-2 pb-6"
                            className=""
                            label="Task Numbers"
                            numbers={"535"}
                        />
