            ...
            <DialogContent className="bg-(--auth-card)">
              ...
              <div>
                <form action="" onSubmit={handleSubmit}>
                  <Field className="">
                    <FieldLabel htmlFor="title" className="text-(--text-2)">
                      Title*
                    </FieldLabel>
                    <FieldContent>
                      <Input
                      ...
                      <div className="md:w-1/2">
                        ...
                        <FieldContent>
                          <Select name="columnId">
                            ...
                            {errors && errors["columnId"] && (
                              <FieldError>{errors["columnId"]}</FieldError>
                            )}
                          </Select>
                        </FieldContent>
                      </div>
                      ...
                      <div className="w-full md:w-1/2">
                        ...
                        <FieldContent>
                          ...
                          {errors && errors["estimatedHours"] && (
                            <FieldError>{errors["estimatedHours"]}</FieldError>
                          )}
                        </FieldContent>
                      </div>
                    </FieldGroup>
                    <FieldLabel htmlFor="assignees" className="text-(--text-2)">
                      Assignees
                    </FieldLabel>
                    <FieldContent>
                      <Input
                      ...
                      />
                      {errors && errors["assigneeIds"] && (
                        <FieldError>{errors["assigneeIds"]}</FieldError>
                      )}
                    </FieldContent>
      ...
      <div className="main-board-section">
        <div className="filters-bar">
          ...
          <div className="flex ">
            ...
            <Dialog>
              <DialogTrigger>Columns</DialogTrigger>
